          ...
          <div className="grid gap-10 items-start justify-center">
            <div className="relative group">
              ...
              <Link className="relative py-3 px-4 bg-gray-800 rounded-xl shadow-md text-xl text-gray-50 font-semibold transition duration-150 ease-in flex items-center space-x-5 w-full" to="/featured">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-4 text-green-500 dark:text-fuchsia-500 -rotate-3 transform" fill="" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.701 2.701 0 00-1.5-.454M9 6v2m3-2v2m3-2v2M9 3h.01M12 3h.01M15 3h.01M21 21v-7a2 2 0 00-2-2H5a2 2 0 00-2 2v7h18zm-3-9v-2a2 2 0 00-2-2H8a2 2 0 00-2 2v2h12z" />
                </svg>
                <span>
                Check out my latest project, <span className="text-yellow-300 dark:text-cyan-400 group-hover:text-gray-100 transition duration-200"> Cook Deck
